        ...
        try:
            ...
            for row_index, row_data in enumerate(res):
                ...
                for col_index, col_data in enumerate(row_data):
                    if col_index == 1:
                        input_data = "未训练" if col_data == -1 else "已训练"
                        self.tableWidget.setItem(row_index, col_index, QTableWidgetItem(str(input_data)))
                    else:
            ...
            try:
                ...
                if os.path.exists('{}/stu_{}'.format(self.datasets, stu_id)):
                    try:
                        ...
                        self.logQueue.put(
                            'Error：删除人脸数据失败，请手动删除{}/stu_{}目录'.format(self.datasets, stu_id))
